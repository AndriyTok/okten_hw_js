...
const rectangle_square = (x, y) => x * y
...
const circle_square = (r) => Math.PI * r ** 2
...
const cylinder_square = (h, r) => 2 * Math.PI * r * h
...
const li_write_with_num = (text, num) => {
    document.write(`<ul>`)
    for (let i = 0; i < num; i++) {
...
const users = [{id: 1, name: "Андрій", age: 25}, {id: 2, name: "Марія", age: 22}, {
    id: 3,
    name: "Олександр",
    age: 30
}, {id: 4, name: "Ірина", age: 28}, {id: 5, name: "Володимир", age: 35}];
...
const swap = (arr, index1, index2) => { //pos = position
